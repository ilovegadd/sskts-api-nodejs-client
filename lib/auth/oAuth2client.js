...
const sasaki_api_abstract_1 = require("@motionpicture/sasaki-api-abstract");
...
class OAuth2client {
    ...
    makeFetch(url, options, expectedStatusCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            const transporter = new sasaki_api_abstract_1.transporters.DefaultTransporter(expectedStatusCodes);
