...
const sasaki_api_service_1 = require("@motionpicture/sasaki-api-service");
...
class OAuth2client extends authClient_1.AuthClient {
    ...
    makeFetch(url, options, expectedStatusCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            const transporter = new sasaki_api_service_1.transporters.DefaultTransporter(expectedStatusCodes);
